    ...
    <div className="flex justify-center items-center h-screen bg-blue-50">
      <div className="bg-white p-8 rounded shadow-lg w-full max-w-sm">
        <div className="text-center mb-6">
          <img src={logo} alt="KostCozy Logo" className="h-32 w-32 mx-auto mb-4" />
          <h2 className="text-2xl font-semibold text-orange-500">Welcome to KostCozy</h2>
          <p className="text-gray-600">Please enter your email, we'll send you otp on your email address</p>
        </div>
        <form>
          <div className="mb-4">
        ...
        <div className="text-center mt-6">
          <p className="text-gray-600">Do you have an account? <a href="/registerform" className="text-orange-500 hover:underline">Sign Up</a></p>
